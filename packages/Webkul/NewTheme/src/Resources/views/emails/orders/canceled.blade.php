            ...
            <tr>
                ...
                <td style="width: 50%; vertical-align: top; padding-right: 15px;">
                    ...
                    <div style="font-family: 'Inter', sans-serif; font-size: 14px; color: #4B5563; line-height: 22px;">
                        ...
                        <span style="color: #9CA3AF; font-size: 13px;">@lang('shop::app.emails.orders.contact'): {{ $order->billing_address->phone }}</span>
                    </div>

                    <p style="font-family: 'Inter', sans-serif; font-size: 12px; font-weight: 700; color: #111827; text-transform: uppercase; margin: 20px 0 5px 0; letter-spacing: 0.5px;">
            ...
            <thead>
                <tr style="background-color: #F9FAFB;">
                    @foreach (['sku', 'name', 'price', 'qty'] as $item)
                        <th style="font-family: 'Inter', sans-serif; text-align: left; padding: 12px 15px; font-size: 11px; font-weight: 700; color: #6B7280; text-transform: uppercase; letter-spacing: 0.5px;">
    ...
    <div style="margin-top: 30px; text-align: right;">
        <table role="presentation" width="280px" cellspacing="0" cellpadding="0" border="0" style="margin-left: auto; border-collapse: collapse;">
            <tr>
                ...
                <td style="padding: 8px 0; font-family: 'Inter', sans-serif; font-size: 14px; color: #111827; text-align: right;">{{ core()->formatPrice($order->sub_total, $order->order_currency_code) }}</td>
            </tr>
            <tr>
                <td style="padding: 8px 0; font-family: 'Inter', sans-serif; font-size: 14px; color: #4B5563;">@lang('shop::app.emails.orders.tax')</td>
                <td style="padding: 8px 0; font-family: 'Inter', sans-serif; font-size: 14px; color: #111827; text-align: right;">{{ core()->formatPrice($order->tax_amount, $order->order_currency_code) }}</td>
            </tr>
            ...
            <tr>
                ...
                <td style="padding: 8px 0; font-family: 'Inter', sans-serif; font-size: 14px; color: #EF4444; text-align: right;">-{{ core()->formatPrice($order->discount_amount, $order->order_currency_code) }}</td>
            </tr>
            @endif
            <tr>
                ...
                <td style="padding: 20px 0 0 0; font-family: 'Inter', sans-serif; font-size: 20px; font-weight: 700; color: #38200F; text-align: right;">{{ core()->formatPrice($order->grand_total, $order->order_currency_code) }}</td>
            </tr>
        </table>
    </div>
